...
#ifndef __hand_num_nn_fcmp_kbM__HH__
#define __hand_num_nn_fcmp_kbM__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hand_num_nn_fcmp_kbM) {
    ...
    SC_CTOR(hand_num_nn_fcmp_kbM):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
